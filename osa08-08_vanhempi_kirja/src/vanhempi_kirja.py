...
def vanhempi_kirja(kirja1: Kirja, kirja2: Kirja):
    ...
    if kirja1.kirjoitusvuosi < kirja2.kirjoitusvuosi:
        print(kirja1.nimi, "on vanhempi, se kirjoitettiin", kirja1.kirjoitusvuosi)

    elif kirja1.kirjoitusvuosi == kirja2.kirjoitusvuosi:
        print(kirja1.nimi, "ja", kirja2.nimi,
              "kirjoitettiin vuonna", kirja1.kirjoitusvuosi)
    else:
        print(kirja2.nimi, "on vanhempi, se kirjoitettiin", kirja2.kirjoitusvuosi)
